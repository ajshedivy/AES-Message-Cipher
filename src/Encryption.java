...
public class Encryption {
    ...
    public static void main(String[] args) throws Exception {
      ...
      SecretKey key = message.getSecretEncryptionKey();
      byte[] text = encryptText("hello", key);
      System.out.println( new String(text));
     
      Encryption newMessage = new Encryption();
      SecretKey key2 = newMessage.getSecretEncryptionKey();
      System.out.println(key2);
      System.out.println(key);
      String undo = message.decryptText(text, key);
      System.out.println(undo);
//        String plainText = "Hello adam shedivy";
